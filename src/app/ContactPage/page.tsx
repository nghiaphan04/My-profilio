...
export default function ContactPage() {
  return (
    <section className="mt-28  bg-black mb-12 md:ms-80 md:mt-0 md:mb-0 md:me-30 min-h-screen text-white px-6 md:py-32 flex flex-col items-center justify-center">
